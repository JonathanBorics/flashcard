...
function Settings() {
    ...
    const updateWordCount = async (level)=>{
        const count = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCEFRWordCount"])(level);
        setWordCount(count);
    };
    const handleCEFRLevelChange = (event, newLevel)=>{
        if (newLevel !== null) {
            setCEFRLevelState(newLevel);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setCurrentCEFRLevel"])(newLevel);
    ...
    const handleResetProgress = ()=>{
        if (confirm("Biztosan törölni szeretnéd az ÖSSZES haladásodat?\n\n" + "Ez törli:\n" + "- Tudott szavak\n" + "- Nem tudott szavak\n" + "- Session statisztikák\n" + "- Mentett játékállás")) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$progressTracker$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["clearKnownWords"])();
...
//# sourceMappingURL=_2311f577._.js.map