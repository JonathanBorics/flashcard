...
// Az új csomag importálása
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$google$2d$translate$2d$open$2d$api$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/google-translate-open-api/dist/index.js [app-route] (ecmascript)");
;
;
;
;
...
// 2. SZOLGÁLTATÓ: Google Translate (az új, megbízhatóbb csomaggal)
async function getGoogleTranslate(word) {
    try {
        console.log(`📡 Próbálkozás a 'google-translate-open-api' csomaggal...`);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$google$2d$translate$2d$open$2d$api$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(word, {
            to: "hu",
            // Itt a varázslat: beépített CORS proxy használata a megbízhatóságért
            browers: true
        });
        // Az új csomag más formátumban adja vissza az adatot
        const translatedText = result.data[0];
        return translatedText ? [
            translatedText.toLowerCase()
        ] : [];
    } catch (error) {
        console.warn(`⚠️ 'google-translate-open-api' hiba: ${error.message}`);
        return [];
    }
}
...
async function GET(request) {
    ...
    // 2. LÉPÉS: Ha nincs helyi találat, jöhet az új Google Translate API
    if (finalMeanings.length === 0) {
        const googleResults = await getGoogleTranslate(word);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__45ec2206._.js.map